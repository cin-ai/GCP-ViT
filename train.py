...
def valid(args, model, writer, test_loader, global_step):
    ...
    if args.local_rank in [-1, 0]:
        ...
        swanlab.log({"valid/loss": eval_losses.avg, "valid/accuracy": val_accuracy}, step=global_step)
...
def train(args, model):
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0]:
                    ...
                    swanlab.log({"train/loss": losses.val, "train/lr": scheduler.get_lr()[0]}, step=global_step)
    ...
    if args.local_rank in [-1, 0]:
        ...
        logger.info("Total Training Time: \t%f" % total_time_hours)
...
def main():
    ...
    parser.add_argument("--dataset", choices=["CUB_200_2011", "car", "dog", "nabirds", "INat2017"],
                        ...
                        help="Which dataset.")
    parser.add_argument('--data_root', type=str, default='/mnt/YCX/datasets')
    parser.add_argument("--model_type", choices=["ViT-B_16", "ViT-B_32", "ViT-L_16",
                                                 "ViT-L_32", "ViT-H_14"],
                        default="ViT-B_16",
                        help="Which variant to use.")
    parser.add_argument("--pretrained_dir", type=str, default="/mnt/YCX/datasets/ViT-B_16.npz",
